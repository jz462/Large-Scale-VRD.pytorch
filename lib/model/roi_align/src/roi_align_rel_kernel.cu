...
#include <math.h>
#include <float.h>
#include "roi_align_rel_kernel.h"
...
#define CUDA_1D_KERNEL_LOOP(i, n)                            \
    ...
    __global__ void ROIAlignRelForward(const int nthreads, const float* bottom_data, const float spatial_scale, const int height, const int width,
    ...
    int ROIAlignRelForwardLaucher(const float* bottom_data, const float spatial_scale, const int num_rois, const int height, const int width,
    ...
    __global__ void ROIAlignRelBackward(const int nthreads, const float* top_diff, const float spatial_scale, const int height, const int width,
    ...
    int ROIAlignRelBackwardLaucher(const float* top_diff, const float spatial_scale, const int batch_size, const int num_rois, const int height, const int width,
